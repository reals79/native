...
const Privacy = () => (
  <ScrollView>
    <Text style={styles.mtitle}>PRIVACY POLICY</Text>
    <Text style={styles.mupdate}>Last updated August 31, 2020</Text>
    <Text style={styles.mdesc}>
      Thank you for choosing to be part of our community at Code3Apps, LLC.
      ...
      <Text style={styles.mlink}>info@code3apps.com</Text>.
    </Text>
    <Text style={styles.mdesc}>
    ...
    <Text style={styles.mdesc}>
      ...
      related services, sales, marketing or events. Please read this privacy
      notice carefully as it will help you understand what we do with the
      information that we collect.
    </Text>
    <Text style={styles.mdesc}>1. WHAT INFORMATION DO WE COLLECT?</Text>
    <Text style={styles.mdesc}>
      In Short: We collect information that you provide to us.
    </Text>
    <Text style={styles.mdesc}>
      We collect personal information that you voluntarily provide to us when
      you register on the express an interest in obtaining information about us
    ...
    <View style={styles.mpview}>
      ...
      <Text style={styles.mparagraph}>
        ...
        section called below.
      </Text>
    </View>
    <View style={styles.mppview}>
      <Text style={styles.mdot}>•</Text>
      <Text style={styles.mparagraph}>
    ...
    <View style={styles.mppview}>
      ...
      <Text style={styles.mparagraph}>
        ...
        when you visit our website and our apps.
      </Text>
    </View>
    <View style={styles.mppview}>
      <Text style={styles.mdot}>•</Text>
      <Text style={styles.mparagraph}>
        ...
        navigate our apps . This information does not reveal your specific
    ...
    <View style={styles.mppview}>
      ...
      <Text style={styles.mparagraph}>
        ...
        all users and may be publicly made available outside the in perpetuity.
        If you interact with other users of our and register for our through a
    ...
    <Text style={styles.mdesc}>4. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</Text>
    <Text style={styles.mdesc}>
    ...
    <Text style={styles.mdesc}>
      Our servers are located in. If you are accessing our from outside, please
    ...
    <Text style={styles.mdesc}>6. HOW LONG DO WE KEEP YOUR INFORMATION?</Text>
    <Text style={styles.mdesc}>
    ...
    <Text style={styles.mdesc}>
      ...
      your personal information for longer than 6 years.
    </Text>
    <Text style={styles.mdesc}>
    ...
    <Text style={styles.mdesc}>7. DO WE COLLECT INFORMATION FROM MINORS?</Text>
    <Text style={styles.mdesc}>
      ...
      children under 18 years of age. By using the , you represent that you are
      at least 18 or that you are the parent or guardian of such a minor and
      consent to such minor dependent’s use of the . If we learn that personal
    ...
    <Text style={styles.mdesc}>
      ...
      account or terminate your account, you can do so through the app, or
      contacting us directly. Upon your request to terminate your account, we
      ...
      Terms of Use and/or comply with applicable legal requirements. Opting out
      of email marketing: You can unsubscribe from our marketing email list at
      any time by clicking on the unsubscribe link in the emails that we send or
      by contacting us using the details provided below. You will then be
      removed from the marketing email list – however, we may still communicate
      with you, for example to send you service-related emails that are
      ...
      opt-out, you may contact us.
    </Text>
    <Text style={styles.mdesc}>9. CONTROLS FOR DO-NOT-TRACK FEATURES</Text>
    <Text style={styles.mdesc}>
    ...
    <Text style={styles.mdesc}>
      ...
      displayed on the , but please be aware that the data may not be completely
      or comprehensively removed from all our systems (e.g. backups, etc.).
    </Text>
    <Text style={styles.mdesc}>11. DO WE MAKE UPDATES TO THIS NOTICE?</Text>
    <Text style={styles.mdesc}>
    ...
    <Text style={styles.mdesc}>
      ...
      request form by contacting us at{' '}
      <Text style={styles.mlink}>info@code3apps.com</Text>
    </Text>
  </ScrollView>
)
